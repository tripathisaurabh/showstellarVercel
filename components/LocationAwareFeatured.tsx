...
export default function LocationAwareFeatured({ initialArtists }: Props) {
  ...
  const title = city ? `Featured in ${city}` : 'Hand-picked profiles worth booking'
  const description = city
    ? `Top-rated artists available near ${city} — curated for your next event.`
    : 'A curated selection of premium artists with strong presentation and high-trust profiles.'
